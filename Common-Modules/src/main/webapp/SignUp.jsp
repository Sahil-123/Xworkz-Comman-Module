                ...
                <form action="signup" method="POST">
                    ...
                    <div class="card-body d-flex flex-column justify-content-center">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="fname" name="fname" onblur="nameValidation('fname')" value="${dto.fname}">
                            <div id="fnameError" class="text-danger"></div>
                        </div>

                        <div class="mb-3">
                            <label for="lname" class="form-label">Last Name</label>
                            <input type="text" class="form-control" id="lname" name="lname" onkeyup="nameValidation('lname')" value="${dto.lname}">
                        ...
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="agree" name="agree" ${dto.agree.equals("on")? checked: ''}>
