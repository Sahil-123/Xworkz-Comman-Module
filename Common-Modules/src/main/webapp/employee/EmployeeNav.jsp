            ...
            <ul class="navbar-nav align-items-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="employee/viewEmployeeComplaints/1/7">View Not Resolved
                                Complaints</a></li>
                        <li><a class="dropdown-item" href="employee/viewEmployeeResolvedComplaints/1/7">View Resolved
                                Complaints</a></li>
                    </ul>
                </li>
...
<%-- ${departmentAdminData} --%>
    ...
    <div class="offcanvas offcanvas-end bg-dark bg-gradient rounded-3 p-2" data-bs-scroll="true"
