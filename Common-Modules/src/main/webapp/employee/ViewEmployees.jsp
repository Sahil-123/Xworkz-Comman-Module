                    ...
                    <div class="table-responsive-sm p-4 ">
                        ...
                        <form action="departmentAdmin/viewAllEmployees/1/7" method="POST">
                            <div
                                ...
                                <input type="text" class="form-control m-1" id="fname" name="fname"
                                    placeholder="First Name">
                                <input type="text" class="form-control m-1" id="lname" name="lname"
                                    placeholder="Last Name">
                                <input type="text" class="form-control m-1" id="email" name="email" placeholder="Email">
                                <input type="text" class="form-control m-1" id="mobile" name="mobile"
                                    placeholder="Mobile">
                                <%-- <input type="number" class="form-control m-1" id="departmentId" name="departmentId"
